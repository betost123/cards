...
//  PlayingCard
//
//  Created by Betina Andersson on 2018-09-11.
...
class PlayingCardView: UIView {
    ...
    var faceCardScale : CGFloat = SizeRatio.faceCardImageSizeToBoundsSize { didSet {
        setNeedsDisplay()}}
    ...
    // Make value on card display nicely
    ...
    // Position your labels for when the bounds change
    ...
    // Make sure it redraws whenever user changes iphone settings
